export class GlobalConstants {
  ...
  public static facebook =
    'https://www.facebook.com/profile.php?id=61557909320358';
  ...
  public static googleMap = 'https://maps.app.goo.gl/9Ds4LaZQhvP59KHR7';
  public static PLAYSTORE_LINK =
    'https://play.google.com/store/apps/details?id=com.kalpaanta.dnba&pcampaignid=web_share';
  public static bio =
    'समाज बिकाश संगै खेलकुदमा व्यावसायिक्ता, स्वास्थ्यको लागि खेलकुद राष्ट्रको लागि खेलकुद आजको आवश्यकता';
  /**
   * {
   * "publicKey":"BHr7BPBGinhF_kPnta2GOZ_lfqqC-NVfB815NDR6t_h5e6M2PBGOPNahFcY9HDwLgGmex9empWyFAQO669Ov-z0",
   * "privateKey":"dm9MtcLXY3IPrfRNmMOG0kvxCLrB4Z2PLjFIDZR0DK4"
   * }
   */

  // SEO
  public static SEOdescription =
    'Discover our Badminton Academy, featuring top-notch training facilities, regular tournaments, and dedicated practice courts. Join us for a membership today!';
