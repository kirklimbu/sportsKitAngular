...
export class HomeService {
  ...
  gallaryUrl = '/assets/data/gallary.json';
  studyDestinationsUrl = '/assets/data/services.json';
  ...
  getBanners(): Observable<any[]> {
    return this.httpClient.get<any[]>(`${this.bannersUrl}`, {
      headers: { skip: 'true' },
    });
  }
  getWelComeMessage(): Observable<any> {
    return this.httpClient.get<any>(`${this.aboutUsUrl}`, {
      headers: { skip: 'true' },
    });
  }

  getWhyUsContents(): Observable<any[]> {
    return this.httpClient.get<any[]>(`${this.whyusUrl}`, {
      headers: { skip: 'true' },
    });
  }
  getStudyDestinationContents(): Observable<any[]> {
    return this.httpClient.get<any[]>(`${this.studyDestinationsUrl}`, {
      headers: { skip: 'true' },
    });
  }
  getGallaryContents(): Observable<any[]> {
    return this.httpClient.get<any[]>(`${this.gallaryUrl}`, {
      headers: { skip: 'true' },
    });
  }
